(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Stage = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
},{"../core":7,"../pin":15,"./easing":1}],4:[function(require,module,exports){
var Class = require('./core');
require('./pin');
require('./loop');
...
},{"./core":7,"./loop":13,"./pin":15,"./util/create":21,"./util/math":25}],5:[function(require,module,exports){
if (typeof DEBUG === 'undefined')
  DEBUG = true;
...
},{"./core":7,"./texture":18,"./util/create":21,"./util/extend":23,"./util/is":24,"./util/string":28}],6:[function(require,module,exports){
var Class = require('./core');
var Texture = require('./texture');
...
},{"./core":7,"./texture":18}],7:[function(require,module,exports){
if (typeof DEBUG === 'undefined')
  DEBUG = true;
...
},{"./util/await":20,"./util/extend":23,"./util/is":24,"./util/stats":27}],8:[function(require,module,exports){
require('./util/event')(require('./core').prototype, function(obj, name, on) {
  obj._flag(name, on);
});

},{"./core":7,"./util/event":22}],9:[function(require,module,exports){
var Class = require('./core');
require('./pin');
require('./loop');
...
},{"./core":7,"./loop":13,"./pin":15,"./util/create":21,"./util/repeat":26}],10:[function(require,module,exports){
...
require('./loop');
require('./root');
},{"./atlas":5,"./core":7,"./event":8,"./loop":13,"./matrix":14,"./pin":15,"./root":16,"./texture":18,"./tree":19}],11:[function(require,module,exports){
var Class = require('./core');
require('./pin');
require('./loop');
...
},{"./core":7,"./loop":13,"./pin":15,"./util/create":21}],12:[function(require,module,exports){
/**
...
function AppLoader(app, configs) {
  configs = configs || {};
  var canvas = configs.canvas, context = null, full = true; // full = false;
...
},{"./core":7,"./pin":15,"./util/stats":27}],14:[function(require,module,exports){
...
},{"./core":7,"./matrix":14}],16:[function(require,module,exports){
var Class = require('./core');
require('./pin');
require('./loop');
...
},{"./core":7,"./loop":13,"./pin":15,"./util/create":21,"./util/extend":23,"./util/stats":27}],17:[function(require,module,exports){
var Class = require('./core');
require('./pin');
require('./loop');
...
},{"./core":7,"./loop":13,"./pin":15,"./util/create":21,"./util/is":24}],18:[function(require,module,exports){
var stats = require('./util/stats');
var math = require('./util/math');
...
},{"./util/math":25,"./util/stats":27}],19:[function(require,module,exports){
var Class = require('./core');
var is = require('./util/is');
...
},{"./core":7,"./util/is":24}],20:[function(require,module,exports){
...
},{"./create":21}],26:[function(require,module,exports){
...
},{"../lib/":10,"../lib/addon/mouse":2,"../lib/addon/tween":3,"../lib/anim":4,"../lib/canvas":6,"../lib/image":9,"../lib/layout":11,"../lib/loader/web":12,"../lib/str":17,"../lib/util/create":21,"../lib/util/extend":23,"../lib/util/math":25}]},{},[29])(29)
});
